...
GS_EMBEDDINGS_BACKUP_BUCKET_NAME = os.environ.get("GS_EMBEDDINGS_BACKUP_BUCKET_NAME", "")
GS_IMAGES_BUCKET_NAME = os.environ.get("GS_IMAGES_BUCKET_NAME", "")
if not all([GS_CREDENTIALS, GS_MODELS_BUCKET_NAME, GS_IMAGES_BUCKET_NAME, GS_EMBEDDINGS_BACKUP_BUCKET_NAME]):
